...
var carMakes =   ['BMW','AUDI','TOYOTA','SUZUKI'];console.log('Old array : ' +carMakes.join()); carMakes.sort(); carMakes.reverse(); console.log('Array in reverse order: ' +carMakes.join());